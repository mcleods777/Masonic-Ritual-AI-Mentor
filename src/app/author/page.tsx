...
export default function AuthorPage() {
  ...
  if (!isDev()) {
    return (
      <div className="rounded-xl border border-red-900/50 bg-red-950/20 p-8 text-red-200 max-w-2xl mx-auto">
        <h1 className="text-2xl mb-3 text-red-100">Author tool disabled</h1>
  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col md:flex-row md:items-end md:justify-between gap-3 pb-2 border-b border-zinc-800">
        <div>
          <h1 className="text-2xl md:text-3xl text-amber-500 tracking-wide">
            Ritual Author Review
          </h1>
          <p className="text-sm text-zinc-400 mt-2">
            Review and correct plain/cipher pairings before they are built into
            a <code className="text-amber-300 font-mono">.mram</code> file. Local only.
          </p>
          {ritualsDir && (
            <p className="text-xs text-zinc-500 mt-1.5 font-mono break-all">
              {ritualsDir}
            </p>
          )}
        </div>
        <div className="flex flex-wrap items-center gap-2">
          <select
            ...
            className="bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-200 focus:border-amber-500 focus:outline-none transition-colors"
          >
          ...
          <button
            ...
            className="px-3 py-2 text-sm border border-zinc-800 rounded-lg text-zinc-300 hover:border-amber-500/50 hover:text-amber-400 transition-colors"
          >
            Reload
          </button>
          <button
            ...
            className="px-4 py-2 text-sm rounded-lg bg-amber-600 text-zinc-950 font-semibold disabled:opacity-40 disabled:cursor-not-allowed hover:bg-amber-500 transition-colors"
          >
      ...
      <details
        ...
        className="rounded-xl border border-zinc-800 bg-zinc-900 hover:border-amber-500/20 transition-colors p-5 group"
      >
        <summary className="cursor-pointer text-sm font-semibold text-zinc-300 group-open:text-amber-400 select-none transition-colors">
          Raw source <span className="font-normal text-zinc-500">(for structural edits: speakers, cues, sections, frontmatter)</span>
        </summary>
        <div className="grid grid-cols-1 gap-4 mt-5">
          <div>
            ...
            <textarea
              ...
              spellCheck={false}
              className="w-full h-80 bg-zinc-950 border border-zinc-800 rounded-lg p-3 font-mono text-xs text-zinc-200 focus:border-amber-500 focus:outline-none transition-colors"
            />
          </div>
          <div>
            <label className="block text-xs uppercase tracking-wider text-zinc-500 mb-2 font-mono">
...
function ValidationSummary({
  ...
  if (!validation) {
    return (
      <div className="rounded-xl border border-zinc-800 bg-zinc-900 px-5 py-4 text-sm text-zinc-400 hover:border-amber-500/20 transition-colors">
        Select a ritual pair to begin. If no pairs appear, drop{" "}
        <code className="text-amber-300 font-mono">name-dialogue.md</code> and{" "}
        <code className="text-amber-300 font-mono">name-dialogue-cipher.md</code> into
        the <code className="text-amber-300 font-mono">rituals/</code> folder.
      </div>
    );
  }
  ...
  return (
    <div
      className={`rounded-xl border px-5 py-4 text-sm grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-3 transition-colors ${
        ok
...
function IssueList({
  ...
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-5 hover:border-amber-500/20 transition-colors">
      <h2 className="text-sm font-semibold text-amber-400 mb-3 tracking-wide uppercase">
...
function PairedView({
  ...
  if (!plain || !cipher) {
    return (
      <div className="rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-12 text-center text-sm text-zinc-500">
...
function ExportPanel({
  ...
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-5 space-y-3 hover:border-amber-500/20 transition-colors">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-semibold text-amber-400 tracking-wide uppercase">
          Encrypt &amp; save <code className="text-amber-300 font-mono normal-case">.mram</code> to
          rituals/
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            spellCheck={false}
            className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-200 font-mono focus:border-amber-500 focus:outline-none transition-colors"
