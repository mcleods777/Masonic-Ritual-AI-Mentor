...
const navItems = [
  ...
  { href: "/voices", label: "Voices", icon: "M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0-11a3 3 0 110-6 3 3 0 010 6z" },
  ...
  { href: "/walkthrough", label: "How It Works", icon: "M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7", desktopOnly: true },
];
